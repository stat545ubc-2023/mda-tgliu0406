...
<!-------------------------- Start your work below ---------------------------->
I would like to explore more on the dataset "flow_sample". It contains information of a time series of annual maximum and minimum flows at a particular station, and I would like to explore more on the trend and magnitude of the annual maximum and annual minimum flow.
<!----------------------------------------------------------------------------->
...
```{r}
### 1. Plot the distribution of a numeric variable
### plot the histogram of flow
ggplot(flow_sample) +
  geom_histogram(aes(x = flow), fill = "steelblue")
...
<!--- *****START HERE***** --->
1. On which year was the most extreme maximum flow?
